...
- Make verb tense consistent in procedure titles. Use "-ing" verbs to title
  tasks and processes (thiis is already done in the majority of cases!):
...
the install instrutions, which are on the doc site.
...
- _Use imperatives for headings of procedures._ Technical writing best practice
  ...
  well. More imporant is to be consistent. Use the same form for all procedure
  headings.
